...
pacman -S alsa-utils archlinuxcn-keyring ark aspell aspell-en aspell-ru audacious audacious-plugins bat bind bleachbit --noconfirm
...
#cp -r cleanup.hook /usr/share/libalpm/hooks/
#
#fi
clear
